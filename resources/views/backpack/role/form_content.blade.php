...
@else
    <div class="card">
        ...
        <div>
            ...
            <div class="card-body">
                @foreach($permissions as $permission=>$listPermission)
                    <p>{{$permission}}</p>

                    @foreach($listPermission as $itemPermission)
                    <label for="{{$itemPermission->id}}">{{$itemPermission->name}}</label>
                    <input id="{{$itemPermission->id}}" type="checkbox" name="{{$itemPermission->id}}" >
                    @endforeach
                @endforeach
            </div>
        </div>
...
@section('after_scripts')
    ...
    <script
        src="{{ asset('packages/backpack/crud/js/'.$action.'.js').'?v='.config('backpack.base.cachebusting_string') }}"></script>
